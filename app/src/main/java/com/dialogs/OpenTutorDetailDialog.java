...
import com.chegou.usuario.CallScreenActivity;
...
public class OpenTutorDetailDialog {
    ...
    public void sinchCall() {
        ...
        if (!generalFunc.isCallPermissionGranted(false)) {
            ...
            OnGoingTripDetailsActivity onGoingTripDetailsActivity = (com.chegou.usuario.OnGoingTripDetailsActivity) MyApp.getInstance().getCurrentAct();
